...
def argparser():
    ...
    P.add_argument('--data_loader', type=str, default='', help='train loader type')

    P.add_argument('--val_data', type=str, default='data/300W_LP_test', help='path to dataset')
    P.add_argument('--val_loader', type=str, default='', help='val loader type')
    ...
    P.add_argument('--initialize', type=str, default='', help='resume from lasteset saved checkpoints')
